        ...
        <section className="text-gray-600 body-font">
            <div className="container px-5 py-8 md:py-16 mx-auto">
                ...
                <div className="flex flex-wrap -m-4">
                    {Product
                    .filter((obj) => obj.products.title.toLowerCase().includes(searchkey))
                        .filter((obj) => obj.products.category.toLowerCase().includes(filterType))
                        .filter((obj) => obj.products.price.includes(filterPrice))
                        .map((item, index) => {
                            // console.log(item)
                            const { products,
                                ...
                                <div className="p-4 md:w-1/4  drop-shadow-lg " > 
                                    ...
                                    <div  className="h-full border-2 hover:shadow-gray-100 hover:shadow-2xl transition-shadow duration-300 ease-in-out    border-gray-200 border-opacity-60 rounded-2xl overflow-hidden" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                        ...
                                        <div className="p-5 border-t-2">
                                            ...
                                            <h1 className="title-font text-lg font-medium text-gray-900 mb-3" style={{ color: mode === 'dark' ? 'white' : '', }}>{products.title}</h1>
                                            <p className="leading-relaxed mb-3" style={{ color: mode === 'dark' ? 'white' : '' }}>RS {products.price}</p>
                                        </div>
