...
//                                     style={{ color: mode === 'dark' ? 'white' : '' }}>Order Details</h1>
...
//                                             </td>
//                                             <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
//                                                 {index.addressInfo.pincode}
//                                             </td>
//                                             <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
//                                                 {index.addressInfo.phoneNumber}
//                                             </td>
//                                             <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
//                                                 {index.email}
//                                             </td>
...
function DashboardTab() {
    const context = useContext(myContext)
    const { mode, Product,products , edithandle, deleteProduct, order, user , setUser } = context
    console.log(setUser)
    let [isOpen, setIsOpen] = useState(false);
    // console.log(order)
    // console.log(Product)
                            ...
                            <div className='  px-4 md:px-0 mb-16'>
                                ...
                                <div className="relative overflow-x-auto ">
                                    <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400  ">
                                        ...
                                        {Product.map((item, index) => {
                                            // console.log(item);
                                            const { products , thumbnail,date } = item;
                                            return (
                                                <tbody
                                                //  key={products.item} 
                                                 className=''>
                                                    <tr className="bg-gray-50 border-b  dark:border-gray-700" style={{ backgroundColor: mode === 'dark' ? 'rgb(46 49 55)' : '', color: mode === 'dark' ? 'white' : '', }} >
                                                        ...
                                                        <th scope="row" className="px-6 py-4 font-medium text-black whitespace-nowrap">
                                                            <img className='w-16' src={thumbnail} alt="img" />
                                                        </th>
                                                        <td className="px-6 py-4 text-black " style={{ color: mode === 'dark' ? 'white' : '' }}>
                                                            {products.title}
                                                        </td>
